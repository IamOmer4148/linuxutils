...
The installer uses **non-interactive** git operations (`GIT_TERMINAL_PROMPT=0`) and falls back to a public tarball install, so it will not ask for GitHub username/password prompts.
